...
//ROUTE 1: fetching all notes for particular logged in user : GET "/api/notes/fetchallnotes" . Login required
...
//ROUTE 2: add new notes using POST for particular logged in user : GET "/api/notes/addnote". Login required
